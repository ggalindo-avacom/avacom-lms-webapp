...
function ModuleLayout({ activeModule, children, language, role, title }) {
  ...
  const onSignOut = () => navigate('/login', { replace: true })

  return (
    <div className="module-shell">
      <header className="module-topbar">
        <strong className="module-topbar__title">{title}</strong>
        <img className="module-topbar__logo" src={logo} alt="AVACOM" />
